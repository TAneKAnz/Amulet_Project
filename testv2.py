...
parent_folder_path = '/Users/tanekanz/DL/pokemon'  # Update with the correct path [origin, grey]

# Get the subfolder names as class names
class_names = sorted(os.listdir(parent_folder_path))[1:] # Get the class names
...
def preprocess_image(image_path):
    img = image.load_img(image_path, target_size=(150, 150))  # fix target_size (128, 224) for each model
